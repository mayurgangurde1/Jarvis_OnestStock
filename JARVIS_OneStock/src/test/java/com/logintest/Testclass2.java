...
public class Testclass2 extends BaseTest {
	...
	public void VerifyLoginFnctionality() throws InterruptedException, IOException{
		...
		loginpage.testValidLogin(UtilityClass.getDatafromPropertyFile("Email"), UtilityClass.getDatafromPropertyFile("Password"));
	}
...
//	}
	...
	@Test(priority = 17)
	public void VerifyUpiIdfield() throws IOException {
		payment.EnterUpiId();
	}
	@Test(priority = 18)
